...
public class DiseaseConfigurationDto extends EntityDto {
	...
	private Set<FacilityReferenceDto> facilities;
	...
	public Set<FacilityReferenceDto> getFacilities() {
		return facilities;
	}
	public void setFacilities(Set<FacilityReferenceDto> diseaseFacilities) {
